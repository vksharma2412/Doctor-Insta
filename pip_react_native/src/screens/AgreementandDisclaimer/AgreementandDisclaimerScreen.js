...
class AgreementandDisclaimerScreen extends Component {
                                ...
                                <View style={{ flex: 1 , backgroundColor: Color.secondayTextColor  }}>
                                    <View style={{ flex: 0.12, backgroundColor: Color.textColor.pentaColor, paddingVertical: 10 }}>
                                        <CommonHeader
                                            ...
                                            headerTrue={Strings.AgreementandDisclaimer.agreementandDisclaimer}
...
export default AgreementandDisclaimerScreen;
