...
class BookSession extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            sessionStatus : this.props.route.params != undefined ? this.props.route.params.data.status : '',
            // userDoubtImages: '',
            ...
            <View style={{ width: '90%', flex: 1, position: 'absolute', bottom: 0, justifyContent: 'flex-end', alignItems: 'center', alignSelf: 'center' }}>
                ...
                <AppButton
                    ...
                    onPress={() => {
                        ...
                        routeParams.status = this.state.sessionStatus
                        ...
                        NavUtil.navUtil.navigateTo(this, Constants.routeName.slotBooking, routeParams,)
                    }}
                    isEnabled={true}
